                    ...
                    <el-form :model="searchForm" :inline="true" ref="searchForm" label-position="left" class="demo-form-inline">
                        ...
                        <div class="userTable boxMain">
                            ...
                            <template>
                                ...
                                <div class="block" v-modal="pagesData" style="padding: 10px 15px">
                                    <el-pagination
        ...
        methods: {
            ...
            handleSubmit() {
                ...
                if(_this.dialogTitle == '添加菜单'){
                    this.$axios.get(_this.$axios.defaults.basePath+'/menu/add',{
                    params:JSON.stringify({            
                        id:_this.id,
                            ...
                            menuKey:_this.formData.menuKey,
                    })
                    }).then(function (res) {
                        if (res.errcode == 0) {
                                _this.$message({
                    ...
                    this.$axios.get(_this.$axios.defaults.basePath+'/menu/update',{
                    params:{            
                        id:_this.id,
                            name:_this.formData.name,
                            desc:_this.formData.desc,
                ...
                if(_this.ids == ''){
                    ...
                    _this.$confirm('此操作将永久删除该员工, 是否继续?', '提示', {
                        ...
                        type: 'warning'
                             ...
                             var _this = this;
                            this.$axios.get(_this.$axios.defaults.basePath+'/menu/delete',{
                            params:{            
                                name:_this.searchForm.name,
                                current:1,
                                size:_this.pagesData.currentRows,
